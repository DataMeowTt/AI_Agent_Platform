...
_INDICATOR_ROWS: tuple[CanonicalIndicator, ...] = (
    ...
    _indicator("log_rGDP_pc_USD", "Log GDP thực bình quân đầu người", "Log Real GDP per Capita USD", "growth_dynamics", "log(USD)", "gold_growth_dynamics", "Logarit GDP thực bình quân đầu người tính bằng USD.", ("GDP per capita", "gdp per capita", "income per capita", "real GDP per capita", "log real GDP per capita", "log rGDP per capita", "GDP bình quân đầu người", "GDP binh quan dau nguoi", "GDP đầu người", "GDP dau nguoi", "thu nhập bình quân", "thu nhap binh quan")),
